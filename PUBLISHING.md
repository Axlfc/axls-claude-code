...
- [ ] Repository renamed to `axls-claude-code` ✅
...
2. Fill in the details:
   - **Repository name**: `axls-claude-code`
   - **Description**: "Axl's personal Claude Code setup for modern development"
...
```bash
cd ~/Documents/GitHub/axls-claude-code

# Add the GitHub remote
git remote add origin https://github.com/axlfc/axls-claude-code.git
...
Your README already includes your GitHub username `axlfc`, so users can copy-paste commands directly!
...
GitHub: https://github.com/axlfc/axls-claude-code
```
...
1. Go to your repo: https://github.com/axlfc/axls-claude-code
...
```bash
/plugin install axlfc/axls-claude-code@v1.0.0
```
