...
# /plugin marketplace add axlfc/axls-claude-code
...
`~/Documents/GitHub/axls-claude-code/`
...
4. **Test Installation** - `/plugin install axlfc/axls-claude-code`
...
https://github.com/axlfc/axls-claude-code
